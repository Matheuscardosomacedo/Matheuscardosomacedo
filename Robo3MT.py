...
def send_order(symbol, order_type, volume, sl_price=None, tp_price=None, comment="Python Bot"):
    ...
    try:
        ...
        # 2. Obter informações do símbolo (com cache)
        symbol_info = get_cached_symbol_info(symbol)
        if symbol_info is None:
        ...
        # 4. VERIFICAR MARGEM DISPONÍVEL ANTES DE ENVIAR ORDEM
        ...
        # 5. Verificar distância mínima para SL/TP
